...
public class MainController {
	...
	//curl localhost:8080/training-springmvc/hello?user=john
	//hello john
	...
	//curl localhost:8080/training-springmvc/formpost -d 'name=john&age=1'
	//{"name":"john","age":1}
	...
	//json post
	//curl localhost:8080/training-springmvc/jsonpost -d '{"name":"john","age":1}' -H 'content-type:application/json'
	//{"name":"john","age":1}
	...
	//JSON array post
	//curl localhost:8080/training-springmvc/jsonspost -d '[{"name":"john","age":22},{"name":"ann","age":18}]' -H 'content-type:application/json'
	...
	//curl localhost:8080/training-springmvc/mappost -d 'a=1&b=2'
	//a:1,b:2
